import Image from "nexthttps://shaily-projects.github.io/register/image";
  ...
  return (
    <>
      ...
      <section className="lg:px-[38px] px-0">
        <div className="bg-[url('https://shaily-projects.github.io/register/image/section-bg.png')] lg:min-h-[717px] h-[100%]  bg-no-repeat bg-cover mt-[16px] relative rounded-[30px] ">
          <div className="md:pt-[81px] md:pb-[29px] md:pr-[51px] md:pl-[66px] px-5 pb-4 h-[100%] flex flex-col max-w-[1500px] mx-auto">
            ...
            <div className="lg:mt-[14px] mt-6   gap-4 md:gap-[30px] mb-[20px] flex md:flex-row flex-col ">
              <div className="flex items-center gap-[16px]">
                <Image
                  src={"https://shaily-projects.github.io/register/image/green-ticks.svg"}
                  alt="green-tick"
                  width={38}
                  height={38}
          ...
          <div>
            <ul className="flex gap-[35px] flex-wrap">
              <li className="max-w-full md:max-w-[calc(50%_-_20px)] xl:max-w-[calc(33%_-_20px)] w-[100%]">
                ...
                >
                  <div className="w-[100%]">
                    <div className="bg-[url('https://shaily-projects.github.io/register/image/card-bg.png')] h-[182px] bg-no-repeat bg-cover w-[100%] bg rounded-[8px] ">
                      <div className="w-[100%] flex justify-between md:px-[32px] px-4">
                        <Image
                          src={"https://shaily-projects.github.io/register/image/phone.svg"}
                          alt="phone"
                          width={43}
                          height={43}
                        />
                ...
                >
                  <div className="w-[100%]">
                    <div className="bg-[url('https://shaily-projects.github.io/register/image/card-bg.png')] h-[182px] bg-no-repeat bg-cover w-[100%] bg rounded-[8px] ">
                      <div className="w-[100%] flex justify-between md:px-[32px] px-4">
                        <Image
                          src={"https://shaily-projects.github.io/register/image/text.svg"}
                          alt="text"
                          width={43}
                          height={43}
                        />
                ...
                >
                  <div className="w-[100%]">
                    <div className="bg-[#3424C2] rounded-[8px] h-[182px] ">
                      <div className="w-[100%] flex justify-between md:px-[32px] px-4">
                        <Image
                          src={"https://shaily-projects.github.io/register/image/building.svg"}
                          alt="building"
                          width={43}
                          height={43}
                        />
        ...
        <div className="lg:pt-[38px] lg:pl-[89px] lg:pr-[66px] lg:pb-[63px] md:px-10 md:py-12 py-6 px-5 bg-[#F4F4F4] rounded-[30px] ">
          ...
          <div className="md:pt-[52px] pt-8">
            <div className=" gap-[60px]  flex xl:flex-row flex-col ">
              <div className="max-w-[614px] w-[100%]">
                <div className="flex  gap-8 md:gap-[50px] md:flex-row flex-col">
                  <div className="md:max-w-[282px] w-[100%]">
                    <Image
                      src={"https://shaily-projects.github.io/register/image/office-building.svg"}
                      alt="office"
                      width={50}
                      height={50}
                    />
                  ...
                  <div className="md:max-w-[282px] w-[100%]">
                    <Image
                      src={"https://shaily-projects.github.io/register/image/bussiness.svg"}
                      alt="office"
                      width={50}
                      height={50}
                    />
                ...
                <div className="flex  gap-8 md:gap-[50px] md:flex-row flex-col md:mt-[40px] mt-8">
                  <div className="md:max-w-[282px] w-[100%]">
                    <Image
                      src={"https://shaily-projects.github.io/register/image/scale.svg"}
                      alt="office"
                      width={50}
                      height={50}
                    />
                  ...
                  <div className="md:max-w-[282px] w-[100%]">
                    <Image
                      src={"https://shaily-projects.github.io/register/image/homework.svg"}
                      alt="office"
                      width={50}
                      height={50}
                    />
              ...
              <Image
                src={"https://shaily-projects.github.io/register/image/handshake.png"}
                alt="My Image"
                width={447}
                height={450}
      ...
      <section className="xl:my-[150px] md:my-[100px] mt-16 mb-4  max-w-[1200px] w-[100%] m-auto  xl:px-0 md:px-8 px-[20px] ">
        <div className="gap-[40px] flex  xl:flex-row flex-col  md:gap-[30px] ">
          ...
          <div className="flex md:gap-[54px] gap-8 items-center flex-wrap">
            <Image
              src={"https://shaily-projects.github.io/register/image/microsoft.svg"}
              alt="microsoft"
              width={100}
              height={21}
            />
            <Image
              src={"https://shaily-projects.github.io/register/image/paypal.svg"}
              alt="paypal"
              width={100}
              height={21}
            />
            <Image
              src={"https://shaily-projects.github.io/register/image/disney.svg"}
              alt="disney"
              width={100}
              height={21}
            />
            <Image
              src={"https://shaily-projects.github.io/register/image/samsung.svg"}
              alt="samsung"
              width={100}
              height={21}
            />
            <Image
              src={"https://shaily-projects.github.io/register/image/spotify.svg"}
              alt="spotify"
              width={100}
              height={21}
            />
            <Image
              src={"https://shaily-projects.github.io/register/image/mcafe.svg"}
              alt="hsbc"
              width={100}
              height={21}
            />
            ...
            <Image
              src={"https://shaily-projects.github.io/register/image/nttgroups.svg"}
              alt="ntt"
              width={100}
              height={21}
            />
            <Image
              src={"https://shaily-projects.github.io/register/image/blackrock.svg"}
              alt="blackrock"
              width={100}
              height={21}
            />
            <Image src={"https://shaily-projects.github.io/register/image/hsbc.svg"} alt="hsbc" width={100} height={21} />
            <Image
              src={"https://shaily-projects.github.io/register/image/accenture.svg"}
              alt="accenture"
              width={100}
              height={21}
            />
            <Image src={"https://shaily-projects.github.io/register/image/uber.svg"} alt="uber" width={100} height={21} />
            <Image
              src={"https://shaily-projects.github.io/register/image/slack.svg"}
              alt="slack"
              width={100}
              height={21}
            />
